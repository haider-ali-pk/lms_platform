  ...
  async function handleSubmit() {
    ...
    try {
      const url = editTeacher
        ? `/api/admin/teachers/${editTeacher.id}`
        : `/api/admin/teachers`;
      const method = editTeacher ? "PUT" : "POST";
      const body: Record<string, unknown> = { ...form };
      if (editTeacher && !form.password) delete body.password;
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">{total} total teachers in your school</p>
        </div>
        <button
          onClick={openCreate}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  placeholder={editTeacher ? "Leave blank to keep current" : "Min 6 characters"}
                />
              </div>
            ...
            <div className="flex gap-3 mt-6">
              ...
              >
                {submitting ? "Saving..." : editTeacher ? "Save Changes" : "Create Teacher"}
              </button>
            </div>
          </div>
        </div>
      ...
      {deleteId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-2">Delete Teacher?</h2>
            <p className="text-sm text-gray-500 mb-6">
              This teacher will be soft-deleted and can be restored later. Are you sure?
            </p>
