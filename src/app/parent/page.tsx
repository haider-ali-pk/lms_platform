...
const STATUS_CONFIG = {
  present: { label: "Present", color: "bg-emerald-100 text-emerald-700", icon: CheckCircle, iconColor: "text-emerald-500" },
  ...
  excused: { label: "Excused", color: "bg-blue-100 text-blue-700", icon: AlertCircle, iconColor: "text-blue-500" },
};
